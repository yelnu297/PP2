...
MUSIC_FOLDER = r"C:\Администратор\Desktop\git\PP2\lab_7\myss"
...
IMAGE_PATH =  r"C:\Администратор\Desktop\git\PP2\lab_7\music\i(7).webp"
...
button_images = {
    "play": pygame.image.load(r"C:\Администратор\Desktop\git\PP2\lab_7\music\play.png"),
    "pause": pygame.image.load(r"C:\Администратор\Desktop\git\PP2\lab_7\music\pause.png"),
    "next": pygame.image.load(r"C:\Администратор\Desktop\git\PP2\lab_7\music\next.png"),
    "prev": pygame.image.load(r"C:\Администратор\Desktop\git\PP2\lab_7\music\back.png"),
}
